...
compute_indicators <- function() {
  ...
  load(here("data", "working_pov.rda"))
  ...
  load(here("data", "literacy.rda"))

  load(here("data", "test_scores.rda"))
